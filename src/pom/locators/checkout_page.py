class Address:
    ...
    country = "com.nopstation.nopcommerce.nopstationcart:id/countrySpinnerLayout"
...
class OrderConfirm:
    Message = "com.nopstation.nopcommerce.nopstationcart:id/md_text_message"
